...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <ul class="nav navbar-nav">
      ...
      <li><a href="categoria_consulta.php">Categorias</a></li>
	  <li><a href="recomendacao_consulta.php">Recomendações</a></li>
      <li><a href="usuario_consulta.php">Usuários</a></li>
	  <li><a href="consulta_funcionarios.php">Funcionários</a></li>
	  
    </ul>
	
	<ul class="nav navbar-nav navbar-right">
        <li><a href=""><span class="glyphicon glyphicon-user"></span> 
		<?php echo $_SESSION['nome_admin'];?></a></li>
